...
def load_transmission(raw: dict | None) -> TransmissionSpectrumConfig:
    ...
    return TransmissionSpectrumConfig(
        ...
        stop_condition=as_str(raw.get("stop_condition", "until_after_sources"), "until_after_sources"),
        until_after_sources=as_str(raw.get("until_after_sources", "200"), "200"),
        field_decay_component=as_str(raw.get("field_decay_component", "Ez"), "Ez"),
        reference_field_decay_additional_time=as_str(
            raw.get("reference_field_decay_additional_time", "50"),
            "50",
        ),
        reference_field_decay_point_x=as_str(raw.get("reference_field_decay_point_x", "0"), "0"),
        reference_field_decay_point_y=as_str(raw.get("reference_field_decay_point_y", "0"), "0"),
        reference_field_decay_by=as_str(raw.get("reference_field_decay_by", "1e-3"), "1e-3"),
        scattering_field_decay_additional_time=as_str(
            raw.get("scattering_field_decay_additional_time", "50"),
            "50",
        ),
        scattering_field_decay_point_x=as_str(raw.get("scattering_field_decay_point_x", "0"), "0"),
        scattering_field_decay_point_y=as_str(raw.get("scattering_field_decay_point_y", "0"), "0"),
        scattering_field_decay_by=as_str(raw.get("scattering_field_decay_by", "1e-3"), "1e-3"),
